...
$arFilter = Array("TYPE_ID" => "V1RT_FEEDBACK_FORM", "ACTIVE" => "Y");
if($site !== false)
	$arFilter["LID"] = $site;
...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"), "EMAIL" => "E-mail", "TEL" => GetMessage("MFP_TEL"), "MESSAGE" => GetMessage("MFP_MESSAGE")),
			"DEFAULT"=>"", 
			"COLS"=>25, 
			"PARENT" => "BASE",
		),
