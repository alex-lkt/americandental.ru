...
CModule::IncludeModule( 'bmhouse.comments' );
...
BMHcomments::saveOptions( $showStats, $includeJquery, $sendMail, $sendMailAddress, $enableModeration, $enableImages, $onlyAuthorized, $showCommentsCount, $enableVoting, $moderationAccess, $answerTitle, $additionalFieldsRequired, $additionalFields, $enableUserpic, $clearCacheComponents );
?>