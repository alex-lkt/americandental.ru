						...
						<div class="col-12 col-md-7 full-w-991">
							<div class="header__info">
			                    <div style="padding-right: 40px;">
			                        ...
			                        <div class="button button_green btn-page"><a style="padding: 10px 20px;" href="#divForm" id="btnForm3" class="btn btn-primary">Бесплатная консультация</a></div>
			                    </div>
								<div class="header__contacts">
			                        ...
			                        <div>
			                        	<a class="collback-text-button btn-page" href="#divForm" id="btnForm11">Заказать обратный звонок</a>
			                        </div>
			                        ...
			                        <ul class="social">
										...
										<li>
											<a href="https://www.instagram.com/vladimir_soyfer/" target="_blank">
												<img src="/local/templates/v1rt-website/img/instagram.png" title="instagram ico" alt="instagram ico">
											</a>
										</li>
										<li>
											<a href="https://www.facebook.com/Americandental-107731420782471/" target="_blank">
												<img src="/local/templates/v1rt-website/img/facebook.png" title="facebook ico" alt="facebook ico">
											</a>
										</li>
										*/?>
										<li>
