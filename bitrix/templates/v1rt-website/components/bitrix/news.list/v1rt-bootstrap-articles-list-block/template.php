...
<div class="dzen-block">
	<img src="<?=SITE_TEMPLATE_PATH?>/images/logo-dzen.png">
	<div>
		<div class="dzen-block__title">
			Читайте больше интересных статей на нашем канале в Яндекс.Дзен
		</div>
		<a href="//zen.yandex.ru/user/992917194" target="_blank" rel="nofollow" class="dzen-block__button">Перейти на канал</a>
	</div>
</div>
