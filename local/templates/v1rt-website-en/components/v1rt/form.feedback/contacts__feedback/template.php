...
<?=bitrix_sessid_post()?>
	<div class="row">
		...
		<div class="col-12">			
			...
			<p><input type="checkbox" checked="" class="agree-check"> By clicking the "Submit" button, I accept the terms of the <a href="/en/user-agreement/">user agreement</a></p>
			<input type="submit" name="submit" value="Submit" class="agree-button btn btn-primary"/>
		</div>
	</div>
</form>
</div>