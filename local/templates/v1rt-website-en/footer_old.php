<?if($APPLICATION->GetCurPage() != "/en/contacts/" && $APPLICATION->GetCurPage() != "/en/"): ?><?$APPLICATION->IncludeFile($APPLICATION->GetTemplatePath("include-areas/inc.form-map.php"), array(), array("MODE" => "html"));?> <?endif; //getcurpage?> 
<footer>
	<div class="container">
		<div class="row justify-content-between">
			...
			<div class="col-12 col-md-4">
				<div class="footer__contacts">
					<a href="tel:+74957964334" class="tel">+7 (495) 796-43-34</a>
					...
					<?/*<span class="address">Moscow, Kastanaevskaya st. 43/2</span>*/?>
