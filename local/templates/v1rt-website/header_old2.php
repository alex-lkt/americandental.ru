...
<html>
	<head>
		...
		<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/css-js/v1rt-forms/v1rt-forms.min.css");?>	
		<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/css-js/SimpleTest/simple-test.css");?>
		...
		<?$APPLICATION->SetAdditionalCSS("https://script.donkin-leads.ru/v2/dentolo.css");?>
					...
					<div class="col-12 col-md-7 full-w-991">
						<div class="header__info">
							...
							<div class="header__contacts">
		                        ...
		                        <div><a class="collback-text-button" href="#divForm" id="btnForm11">Заказать обратный звонок</a></div>
