...
<?if(!$bIndexBot):?>
	...
	<div class="slider-item">
		...
		Пациент 65 лет. Проведена реабилитация с помощью дентальных имплантатов по системе "All-on-4". Одновременно с удалением оставшихся зубов были установлены имплантаты с немедленной нагрузкой временными конструкциями. Затем пациенту были установлены окончательные металлокерамические коронки.
		</div>
	</div>
