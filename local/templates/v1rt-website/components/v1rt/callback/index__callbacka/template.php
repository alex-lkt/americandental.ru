...
<?=bitrix_sessid_post()?>
	<input type="text" name="user_name" value="<?=$arResult["AUTHOR_NAME"]?>" placeholder="Ваше имя" maxlength="12"/>
	<input type="text" name="user_phone" value="<?=$arResult["AUTHOR_PHONE"]?>" class="js-validate-phone" placeholder="+7 (___) ___-__-__"/>
	...
	<?if($arParams["USE_CAPTCHA"] == "Y"):?>
			...
			<img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["capCode"]?>" width="180" height="40" title="CAPTCHA" alt="CAPTCHA"/><br>
	...
	<?endif;?>
		<p>
			...
			<input type="submit" name="submit" value="Отправить" class="btn btn-primary" onclick="ym(56550514,'reachGoal','submit'); return true;"/>
		</p>
