 ...
 <img alt="Виды установки имплантов All-on-4" title="Виды установки имплантов All-on-4" src="/images/vidy-ustanovki-vse-na-4.png">
	...
	<div class="index__moreservices">
		<div class="container uslugi__moreservices">
			...
			<div class="row">
				<div class="col-12 col-md-6">
 <a href="/implantaciya-zubov/" class="wow fadeInDown"> <img src="/upload/medialibrary/f91/f917f6e1fea7123274e9c5aeed1012a7.jpg" title="Имплантация" alt="Имплантация"> <span class="name">Имплантация</span> </a>
				</div>
				<div class="col-12 col-md-6">
