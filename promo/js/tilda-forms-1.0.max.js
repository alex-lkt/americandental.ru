...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    !t || (r = t.getAttribute("data-tilda-project-lang")) && (window.t_forms__lang = r), t_forms__initForms();
    ...
    (e || t || r) && (o = "tilda-forms-payments-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript", a.src = "https://static.tildacdn.com/js/" + o + ".min.js", a.onerror = function() {
        console.error("Failed to load tilda-forms-payments: ", this.src)
    }, document.head.appendChild(a)));
    var o, a, r = window.t_forms__lang;
    "RU" !== r && "EN" !== r && (o = "tilda-forms-dict-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript", a.src = "https://static.tildacdn.com/js/" + o + ".min.js", a.onerror = function() {
    ...
    var t;
    !0 !== window.isInitEventsCustomMask && ((t = document.createElement("script")).type = "text/javascript", t.src = "https://static.tildacdn.com/js/tilda-forms-custommask-1.0.min.js", document.head.appendChild(t), window.isInitEventsCustomMask = !0)
    ...
    var e, r, o, a, n, i, s;
    "object" == typeof t && !t.length || (t instanceof Element || (t = t[0]), e = t.querySelectorAll(".js-errorbox-all"), r = t.querySelectorAll(".js-rule-error"), o = t.querySelectorAll(".js-error-rule-all"), a = t.querySelectorAll(".js-successbox"), n = t.querySelectorAll(".js-error-control-box"), i = t.querySelectorAll(".js-error-control-box .t-input-error"), s = document.getElementById("tilda-popup-for-error"), Array.prototype.forEach.call(e, function(t) {
        ...
        if (e[p] && e[p].obj) {
            ...
            for (var _ = 0; _ < e[p].type.length; _++) {
                var y = e[p].type[_],
                    w = t_forms__getMsg(y),
                    l = "";
                (r = t.querySelector(".js-rule-error-" + y)) ? r.textContent && r.innerText || !w || -1 !== d.indexOf(w) ? (l = r.textContent || r.innerText, -1 === d.indexOf(w) && (d = d + '<p class="t-form__errorbox-item">' + l + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + w + "</p>": w && -1 === d.indexOf(w) && (d = d + '<p class="t-form__errorbox-item">' + w + "</p>"), i && (!l && t_forms__getMsg(y + "field") ? l = t_forms__getMsg(y + "field") : w && (l = w), l && n && (s = n.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, function(t) {
                    t.innerHTML = l, t_fadeIn(t)
                })))
            }
        }
    function h(t) {
        "INPUT" === ((t = t || window.event).target || t.srcElement).tagName && (t = u.querySelectorAll("form .t-input-error"), t_fadeOut(c), Array.prototype.forEach.call(t, function(t) {
    ...
    return d && (c.querySelector(".t-form__errorbox-text").innerHTML = d, m = c.querySelectorAll(".t-form__errorbox-item"), Array.prototype.forEach.call(m, function(t) {
        t.style.display = "block"
    }), t_fadeIn(c)), window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout(function() {
        t_fadeOut(c), s = t.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, function(t) {
            t.innerHTML = "", t_fadeOut(t)
        }), window.t_forms__errorTimerID = 0
    }, 1e4), window.isInitEventsZB[o] || (u = t.closest(".r"), m = "focus", document.addEventListener || (m = "focusin"), t_removeEventListener(u, m, h), t_addEventListener(u, m, h, !0), t_removeEventListener(u, "change", h), t_addEventListener(u, "change", h, !0)), t_triggerEvent(t, "tildaform:aftererror"), !0
    ...
    t instanceof Element || (t = t[0]);
    var r, o = document.getElementById("tildaformcaptchabox"),
    ...
    e = '<div id="tildaformcaptchabox" style="z-index: 99999999999; position:fixed; text-align: center; vertical-align: middle; top: 0px; left:0px; bottom: 0px; right: 0px; background: rgba(255,255,255,0.97);"><iframe id="captchaIframeBox" src="//' + window.tildaForm.endpoint + "/procces/captcha/?tildaspec-formid=" + t.getAttribute("id") + "&tildaspec-formskey=" + e + "&" + r + '" frameborder="0" width="100%" height="100%"></iframe></div>';
    ...
    t_hasClass(e, "t-body_scroll-locked") || (t = void 0 !== window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, t_addClass(e, "t-body_scroll-locked"), e.style.top = "-" + t + "px", e.setAttribute("data-popup-scrolltop", t))
}, window.tildaForm.unlockBodyScroll = function() {
    var t, e = document.body;
    t_hasClass(e, "t-body_scroll-locked") && (t = e.getAttribute("data-popup-scrolltop"), t_removeClass(e, "t-body_scroll-locked"), e.style.top = null, e.removeAttribute("data-popup-scrolltop"), document.documentElement.scrollTop = parseInt(t))
            ...
            if (4 === xhr.readyState)
                if (200 <= xhr.status && xhr.status < 400) {
                        ...
                        if ("object" == typeof objData) {
                            ...
                            if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", objData && objData.error) {
                                ...
                                if (window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics) {
                                    window.tildaForm.tildapayment && window.tildaForm.tildapayment.amount ? (price = window.tildaForm.tildapayment.amount, 0 < parseFloat(price) && (title = "Order " + formResult.orderId)) : priceEl && (price = priceEl.value, 0 < parseFloat(price) && (title = "Order " + formResult.orderId));
                                    try {
                    ...
                    if (!xhr || 0 == xhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function(t) {
                        ...
                        if (xhr && (500 <= xhr.status || 408 == xhr.status || 410 == xhr.status || 429 == xhr.status || "timeout" == xhr.statusText) && -1 !== window.tildaForm.endpoint.indexOf("forms.tilda")) return window.tildaForm.endpoint = "forms2.tildacdn.com", window.tildaForm.send(form, btnSubmit, formType, formKey), !1;
    ...
    return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function() {
        if (4 === xhr.readyState)
            if (200 <= xhr.status && xhr.status < 400) {
                ...
                window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics ? window.Tilda.sendEventToStatistics(i, t, "", 0) : "undefined" != typeof ga && "tilda" !== window.mainTracker ? ga("send", {
                    hitType: "pageview",
                    page: i,
                    title: t
                }) : "" < window.mainMetrika && window[window.mainMetrika] && window[window.mainMetrika].hit(i, {
                    title: t,
                    referer: window.location.href
                ...
                var s, a = (s = t_forms__getErrorContainers(form, "")).errorBoxes,
                    n = s.allError,
                    l = xhr.responseText;
                Array.prototype.forEach.call(n, function(t) {
                    l ? t.innerHTML = l + ". Please, try again later. [" + xhr.status + "]" : xhr.statusText ? t.innerHTML = "Error [" + xhr.statusText + "]. Please, try again later. [" + xhr.status + "]" : t.innerHTML = "Unknown error. Please, try again later. [" + xhr.status + "]", t.style.display = "block"
                }), Array.prototype.forEach.call(a, function(t) {
                    t.style.display = "block"
                }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "tildaform:aftererror")
            }
...
function t_forms__initForms() {
    ...
    window.t_forms__inputData = {}, t_forms__addRecaptcha(), Array.prototype.forEach.call(t, function(t) {
        var e = t.id;
        window.initForms[e] || (t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t), t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t), t_forms__addFocusOnTab(t), window.initForms[e] = !0)
    })
}

function t_forms__addFocusOnTab(t) {
    var e;
    window.isMobile || (t = t.querySelectorAll(".t-input, .t-select")) && (e = null, document.addEventListener("keydown", function() {
        e = "keyboard"
...
function t_forms__removePlaceholder(t) {
    var e, r, o = (t = t || window.event).target || t.srcElement;
    "INPUT" === o.tagName && (r = o.closest("[data-input-lid]"), e = o.getAttribute("placeholder"), t = "", r ? t = r.getAttribute("data-input-lid") : (r = o.closest("form")) && (t = r.getAttribute("data-input-lid")), e && t && (window.t_forms__inputData[t] = e, o.setAttribute("placeholder", "")))
}
    ...
    if (r) {
        ...
        if (o) {
            ...
            if (r.tildaSendingStatus && (t = r.tildaSendingStatus), !(t && 1 <= t || t_hasClass(r, "t706__submit_disable"))) {
                if (t_addClass(r, "t-btn_sending"), r.tildaSendingStatus = "1", window.tildaForm.hideErrors(o), e = window.tildaForm.validate(o), window.tildaForm.showErrors(o, e)) return t_removeClass(r, "t-btn_sending"), void(r.tildaSendingStatus = "0");
                ...
                if (o.querySelector(".g-recaptcha") && grecaptcha) {
                    ...
                    return n ? grecaptcha.reset(n) : (i = {
                        size: "invisible",
                        sitekey: o.getAttribute("data-tilda-captchakey"),
                        callback: window.tildaForm.captchaCallback
                    }, n = grecaptcha.render(a + "recaptcha", i), o.tildaCaptchaClientId = n), void grecaptcha.execute(n)
                }
...
function t_forms__submitEvent(t) {
    var e, r = t;
    t.target && (r = t.target), r && (e = "", (r = r.querySelector('[type="submit"]')) && r.tildaSendingStatus && (e = r.tildaSendingStatus), e && "3" === e ? r.tildaSendingStatus = "" : (r && !t_hasClass(r, "t706__submit_disable") && r.click(), t.preventDefault ? t.preventDefault() : t.returnValue = !1))
}
...
function t_forms__addRecaptcha() {
    ...
    Array.prototype.forEach.call(t, function(t) {
        var e, r, o, a = t.getAttribute("data-tilda-captchakey");
        a ? (e = t.getAttribute("id"), window.tildaForm.isRecaptchaScriptInit || (r = document.head, o = document.createElement("script"), window.tildaForm.isRecaptchaScriptInit = !0, o.type = "text/javascript", o.src = "https://www.google.com/recaptcha/api.js?render=explicit", o.async = !0, r.appendChild(o), r.insertAdjacentHTML("beforeend", '<style type="text/css">.js-send-form-success .grecaptcha-badge {display: none;}</style>')), document.getElementById(e + "recaptcha") || t.insertAdjacentHTML("beforeend", '<div id="' + e + 'recaptcha" class="g-recaptcha" data-sitekey="' + a + '" data-callback="window.tildaForm.captchaCallback" data-size="invisible"></div>')) : t_removeClass(t, "js-tilda-captcha")
    })
}
...
function t_forms__onSuccess(t) {
    ...
    if (l > window.scrollY || n - s < a - 100) o.classList.add(c), n < a && p && setTimeout(function() {
        t_fadeOut(p)
    }, 300);
    else {
        ...
        m && t_forms__scrollBeginForm(d), setTimeout(function() {
            o.classList.add(c)
        }, 400)
    }
    ...
    }, 500), 835 != r && 862 != r || (e = e.querySelector(".t835__btn_prev")) && (e.style.display = "none")
}
...
Array.prototype.some || (Array.prototype.some = function(t) {
        ...
        for (var e = Object(this), r = e.length >>> 0, o = 2 <= arguments.length ? arguments[1] : void 0, a = 0; a < r; a++)
    ...
    function(t) {
        ...
        t.matches = t.matchesSelector = e || function(t) {
        ...
        e |= 0;
        if (a <= e) return -1;
        for (r = Math.max(0 <= e ? e : a - Math.abs(e), 0); r < a; r++)
...
function t_serializeArray(t) {
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o = 0; o < r.length; o++)
        if (!(!r[o].name || r[o].disabled || -1 < ["file", "reset", "submit", "button"].indexOf(r[o].type)))
            if ("select-multiple" !== r[o].type) - 1 < ["checkbox", "radio"].indexOf(r[o].type) && !r[o].checked || e.push({
                name: r[o].name,
                value: r[o].value
            });
            else
...
function t_fadeOut(t) {
    var e, r;
    "none" !== t.style.display && (e = 1, r = setInterval(function() {
...
function t_fadeIn(t) {
    var e, r;
    "block" !== t.style.display && (e = 0, t.style.opacity = e, t.style.display = "block", r = setInterval(function() {
        t.style.opacity = e, 1 <= (e += .1) && clearInterval(r)
    }, 30))
}
