...
function t_zeroForms__renderForm(t, e, r, o) {
    if (t = t_zeroForms__getEl(t), o = o || t_zeroForms__getTildaMode(), r || "zero" === o || "edit" === o || (r = t.closest(".r").id.replace("rec", "")), "string" == typeof e) try {
        e = JSON.parse(e)
    } catch (t) {}
    ...
    if (!t.classList.contains("zero-form-rendered") || n) {
        ...
        if (!t_zeroForms__isRecordHidden(n) && !t_zeroForms__isFormOutside(t) || "published" !== o) {
            ...
            if ("zero" === o || "edit" === o) e.innerHTML = "";
            else if (e.querySelector(".t-form")) return;
            r = t_zeroForms__createForm(r, o, n, t);
            r && (e.insertAdjacentElement("beforeend", r), (o = document.createEvent("Event")).initEvent("render", !0, !0), t.dispatchEvent(o), t.classList.add("zero-form-rendered"), t_zeroForms__initMaskAfterRender(t))
        }
    }
}
...
function t_zeroForms__createForm(e, t, r, o) {
    t = t || t_zeroForms__getTildaMode();
    var n = t_zeroForms__createFormObj(o),
        i = "published" === t,
        a = r.filter(function(t) {
            return "y" !== t.loff && "hd" !== t.li_type
        }),
        s = document.createElement(i ? "form" : "div");
    s.classList.add("t-form"), s.classList.add("t-form_inputs-total_" + a.length), n.inputsstyle && s.classList.add("t-form_bbonly"), "h" === n.inputpos && s.classList.add("tn-form_horiz"), i && (s.id = "form" + e, s.name = "form" + e, s.action = "https://forms.tildacdn.com/procces/", s.method = "POST", s.classList.add("js-form-proccess"), s.setAttribute("role", "form"), s.setAttribute("data-formactiontype", "2"), s.setAttribute("data-inputbox", ".t-input-group"), s.setAttribute("data-success-callback", "t396_onSuccess"), s.setAttribute("data-success-popup", "y"), s.setAttribute("data-error-popup", "y"), n.formmsgurl && s.setAttribute("data-success-url", n.formmsgurl));
    (n.receivers ? n.receivers.split(",") : []).forEach(function(t) {
        t = t_zeroForms__createHiddenField(t, "formservices[]", "js-formaction-services");
        s.insertAdjacentElement("beforeend", t)
    }), n.formname && (a = t_zeroForms__createHiddenField(n.formname, "tildaspec-formname", ""), s.insertAdjacentElement("beforeend", a));
    var l, d, i = document.createElement("div"),
        a = (i.classList.add("js-successbox"), i.classList.add("t-form__successbox"), i.classList.add("t-text"), i.classList.add("t-text_sm"), i.style.display = "none", i.innerHTML = n.formmsgsuccess, s.insertAdjacentElement("beforeend", i), {
            color: n.inputtitlecolor || "",
            fontWeight: n.inputtitlefontweight || "",
            fontFamily: n.inputfontfamily || "",
            fontSize: n.inputtitlefontsize || "",
            paddingBottom: n.inputtitlemargbottom || ""
        }),
        i = t_zeroForms__generateInputsBlock(e, o, r, n, a),
        c = (s.insertAdjacentElement("beforeend", i), o.getAttribute("data-elem-id")),
        a = (n.formbottomtext && ((r = document.createElement("div")).style.textAlign = "center" === n.buttonalign ? "center" : "left", r.style.color = a.color, r.style.fontWeight = a.fontWeight, r.style.fontFamily = a.fontFamily, r.style.marginTop = "15px", r.style.fontSize = "13px", i = t_zeroForms__getBottomText(c, n, e, o), r.appendChild(i), s.insertAdjacentElement("beforeend", r)), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(n, "bottom")), s.insertAdjacentElement("beforeend", t_zeroForms__createCommentField()), t_zeroForms__createInputPlaceholderStyles(c, n, e, o), "h" !== n.inputpos && "zero" !== t || t_zeroForms__setScriptOrStyle("t-zero-form-h-styles", "tilda-zero-form-horizontal.min.css", "", "link", !1), t_zeroForms__setScriptOrStyle("t-zero-form-c-styles", "", ".tn-atom .t-input-block {position: relative;}", "style", o), "y" === n.inputsstyle2 && t_zeroForms__onRender(o, !1, function() {
            t_zeroForms__animateInputs(o, n, e, c)
        }), "t-zero-form-font-family-" + e + "-" + c),
        a = (n.fieldfontfamily ? (l = t_zeroForms__createSelector(e, c, ""), t_zeroForms__setScriptOrStyle(a, "", (d = (d = ['input[type="text"]', 'input[type="tel"]', ".t-input-phonemask__select", "textarea", "select", ".t-input__vis-ph"]).reduce(function(t, e, r) {
            return t += l + ".t-input-block " + e, r !== d.length - 1 && (t += ", "), t
        }, "")) + ' {font-family: "' + n.fieldfontfamily + '";}', "style", o)) : (i = document.getElementById(a)) && i.parentElement && i.parentElement.removeChild(i), "preview" !== t && "published" !== t || t_zeroForms__onFuncLoad("tildaForm_initMasks", function() {
            tildaForm_initMasks()
        }), "published" === t && (r = document.querySelectorAll('[data-record-type="803"]'), Array.prototype.forEach.call(r, function(t) {
            var e = t.id.replace("rec", "");
            t_zeroForms__onFuncLoad("t803_init", function() {
                t803_init(e)
            })
        })), window.t_zeroForms__isMobile || "ontouchend" in document ? "orientationchange" : "resize"),
        _ = t_zeroForms__getTildaMode(),
        u = 0;
    return window.addEventListener(a, function() {
        u = u || setTimeout(function() {
            var t;
            void 0 !== window.t396_detectResolution && void 0 !== window.t396_switchResolution && "edit" !== _ && (t = t396_detectResolution(e), t396_switchResolution(e, t)), t_zeroForms__updateStylesOnResize(e, o), clearTimeout(u), u = 0
        }, 600)
    }), s
}

function t_zeroForms__updateStylesOnResize(t, e) {
    var r = t_zeroForms__createFormObj(e),
        ...
        s = (Array.prototype.forEach.call(a, function(t) {
        ...
        a = e.querySelectorAll(".t-input-inline-styles"),
        ...
        n = e.querySelectorAll(".t-input-title"),
        i = (Array.prototype.forEach.call(n, function(t) {
            t_zeroForms__setTitleStyles(t, l, d)
        }), e.querySelectorAll(".t-input-group")),
        c = r.inputmargbottom ? "margin-bottom:" + r.inputmargbottom + "px;" : "",
        a = ((c += r.inputmargright && "h" === r.inputpos ? "padding-right:" + r.inputmargright + "px;" : "") && Array.prototype.forEach.call(i, function(t) {
            t.style = c
        }), e.querySelector(".t-submit"));
    a && (t_zeroForms__setBtnInlineStyles(r, a), t_zeroForms__generateBtnStyles(a, t, o, r, e), (n = a.closest(".tn-form__submit")) && (n.style.textAlign = r.buttonalign, n.style.marginTop = r.buttonmargtop + "px"))
}
...
function t_zeroForms__generateInputsBlock(e, r, t, o, n) {
    var i = r.getAttribute("data-elem-id"),
...
function t_zeroForms__parseIntoElement(e, r, o, n, t, i) {
    ...
    e = e || (e = r.closest(".r") ? r.closest(".r").id : "").replace("rec", "");
    var a, s, l = n.inputmargbottom ? "margin-bottom:" + n.inputmargbottom + "px;" : "",
        d = (l += n.inputmargright && "h" === n.inputpos ? "padding-right:" + n.inputmargright + "px;" : "", document.createElement("div")),
        l = (d.classList.add("t-input-group"), d.classList.add("t-input-group_" + o.li_type), d.setAttribute("data-input-lid", o.lid), l && (d.style = l), "variation" === n.inputfontweight ? n.inputvariationweight : n.inputfontweight),
        c = "variation" === n.inputelsfontweight ? n.inputelsvariationweight : n.inputelsfontweight,
        _ = "variation" === n.inputtitlefontweight ? n.inputtitlevariationweight : n.inputtitlefontweight,
        u = (o.li_title && t_zeroForms__generateTitle(o, t, d, _), o.li_subtitle && t_zeroForms__generateSubtitle(o, t, d), t_zeroForms__initInputStyles(n, l)),
        m = {
            fontSize: n.inputelsfontsize || "",
            fontWeight: c || ""
        },
        p = {
            name: o.li_nm,
    ...
    switch (_.classList.add("t-input-block"), o.li_type) {
        case "em":
            f = t_zeroForms__createInput(o, u, p, "email");
            break;
        case "ph":
            f = t_zeroForms__createPhoneInput(e, o, u, p), "a" === o.li_masktype && (t_zeroForms__setScriptOrStyle("t-zero-phonemask", "tilda-phone-mask-1.1.min.js", "", "script", !1), t_zeroForms__onRender(r, !0, function() {
            ...
            break;
        case "nm":
            f = t_zeroForms__createInput(o, u, p, "name");
            break;
        case "in":
            f = t_zeroForms__createInput(o, u, p, "oneline");
            break;
        case "ta":
            f = t_zeroForms__createInput(o, u, p, "textarea");
            break;
        case "sb":
            var f = t_zeroForms__createSelect(o, u, p);
            (n.inputsstyle && n.inputelscolor || u.color) && (y = document.createElement("style"), b = t_zeroForms__createSelector(e, i, ".t-select__wrapper:after"), g = n.inputsstyle ? n.inputelscolor : u.color, y.textContent = b + "{border-top-color:" + g + ";}", f.insertAdjacentElement("beforeend", y));
            break;
        case "rd":
            f = t_zeroForms__createRadio(o, n, p, m);
            var b = "cb" === o.li_radcb ? "checkbox" : "radio",
                g = (t_zeroForms__setIndicatorStyles(e, i, n.inputelscolor, b, f), e ? "#rec" + e + " " : "");
            t_zeroForms__setScriptOrStyle("t-zero-form-fieldset-" + e, "", g += "fieldset {padding: 0; margin: 0; border: none;}", "style", r), "checkbox" == b && t_zeroForms__onRender(r, !1, function() {
        ...
        case "ri":
            ...
            break;
        case "cb":
            f = t_zeroForms__createCheckbox(o, m, n, p), t_zeroForms__setIndicatorStyles(e, i, n.inputelscolor, "checkbox", f);
            break;
        case "uw":
            f = t_zeroForms__createUploadField(o, p, "uw"), "published" === window.tildamode && t_zeroForms__onRender(r, !0, function() {
            ...
            break;
        case "uc":
            f = t_zeroForms__createUploadField(o, p, "uc");
            var y = 'UPLOADCARE_LOCALE ="' + o.li_inp + '";';
            t_zeroForms__setScriptOrStyle("t-zero-uploadcare-" + i, "", y += 'UPLOADCARE_TABS = "all";', "script", !1);
            break;
        case "da":
            f = t_zeroForms__createDateField(o, p, u, n), t_zeroForms__onRender(r, !0, function() {
            ...
            break;
        case "tm":
            f = t_zeroForms__createInput(o, u, p, "time");
            break;
        case "qn":
            f = t_zeroForms__createQuantityField(o, u, n.inputelscolor, p), r.removeEventListener("click", t_zeroForms__initQuanityClickCount), r.addEventListener("click", t_zeroForms__initQuanityClickCount);
            break;
        case "rg":
            f = t_zeroForms__createQuantityRange(o, u, n, p), n.inputelscolor && (a = document.createElement("style"), s = t_zeroForms__createSelector(e, i, ".t-range"), ["::-webkit-slider-thumb", "::-moz-range-thumb", "::-ms-thumb"].forEach(function(t) {
                a.textContent += s + t + "{background:" + n.inputelscolor + ";}"
            }), f.insertAdjacentElement("beforeend", a)), t_zeroForms__onRender(r, !1, function() {
            ...
            break;
        case "ur":
            f = t_zeroForms__createInput(o, u, p, "url");
            break;
        case "tx":
            (f = document.createElement("div")).classList.add("t-text"), f.setAttribute("field", "li_text__" + o.lid), f.style.fontWeight = m.fontWeight, f.style.fontSize = m.fontSize + "px", f.style.fontFamily = t.fontFamily, f.style.color = t.color, f.innerHTML = o.li_text || "";
            break;
        case "ws":
            (f = document.createElement("div")).innerHTML = "&nbsp";
            o.li_rows && (f.style.height = 34 * o.li_rows + "px");
            break;
        case "fr":
            f = t_zeroForms__createCalculation(o, u, p, t), n.inputfrbgcolor && (g = document.createElement("style"), b = t_zeroForms__createSelector(e, i, ".t-input-group_fr"), g.textContent = b + "{background-color:" + n.inputfrbgcolor + "; padding: 20px 30px 25px;}", f.insertAdjacentElement("beforeend", g)), t_zeroForms__onRender(r, !1, function() {
    ...
    return l.classList.add("t-input-error"), _.insertAdjacentElement("beforeend", l), d.insertAdjacentElement("beforeend", _), d
}
...
function t_zeroForms__createSelect(t, o, e) {
    var r = t.li_variants ? t.li_variants.split("\n") : [],
        n = parseInt(t.li_defselitem, 10),
        i = document.createElement("div"),
        a = (i.classList.add("t-select__wrapper"), e.secondaryClassName && i.classList.add("t-select__wrapper_bbonly"), document.createElement("select"));
    return a.id = t.li_type + "-" + t.lid, t_zeroForms__appendMainSettingToField(a, e, "", "t-select"), e.secondaryClassName && a.classList.add("t-select_bbonly"), e.require && a.setAttribute("data-tilda-req", "1"), t_zeroForms__appendStylesToField(a, o), t.li_selfirstvar && ((e = document.createElement("option")).textContent = t.li_selfirstvar, e.setAttribute("value", ""), a.insertAdjacentElement("beforeend", e)), r.forEach(function(t, e) {
        var r = document.createElement("option");
        r.value = t, r.textContent = t, o && o.color && "transparent" !== o.backgroundColor && (r.style.color = o.color), n && n === e + 1 && (r.selected = !0), a.insertAdjacentElement("beforeend", r)
    }), i.insertAdjacentElement("beforeend", a), i
}

function t_zeroForms__createRadio(i, a, s, l) {
    var t = i.li_variants ? i.li_variants.split("\n") : [],
        d = "cb" === i.li_radcb,
        c = parseInt(i.li_defselitem, 10),
        e = document.createDocumentFragment(),
        r = t_zeroForms__createWrapper((d ? "t-checkboxes" : "t-radio") + "__wrapper"),
        _ = (d && e.appendChild(t_zeroForms__createNameFieldForCheckbox(s, r, "checkboxes")), e.appendChild(r), d ? "checkbox" : "radio"),
        u = document.createElement("fieldset");
    return r.insertAdjacentElement("beforeend", u), t.forEach(function(t, e) {
        var r = t_zeroForms__createLabel(_, l, a),
            o = document.createElement("input"),
            n = (o.type = _, o.value = t, o.classList.add("t-" + _), d || o.classList.add("js-tilda-rule"), d || (o.name = s.name), i.li_title || i.li_subtitle),
            n = (!d && n && (o.ariaLabel = n), c && c === e + 1 && (o.checked = !0), s.require && o.setAttribute("data-tilda-req", "1"), r.insertAdjacentElement("beforeend", o), t_zeroForms__createIndicator(_, a.inputelscolor, !1)),
            e = (r.insertAdjacentElement("beforeend", n), document.createElement("span"));
        e.textContent = t, r.insertAdjacentElement("beforeend", e), u.insertAdjacentElement("beforeend", r)
    }), e
}

function t_zeroForms__createRadioImage(n, i, a) {
    var t, s, e, l, d, c, _ = "cb" === n.li_radcb;
    if (n.li_gallery) try {
        t = JSON.parse(n.li_gallery)
    } catch (t) {}
    if (t) return t = t_zeroForms__fromObjToArray(t), s = parseInt(n.li_defselitem, 10), e = document.createDocumentFragment(), l = t_zeroForms__createWrapper("t-img-select__container"), l.setAttribute("data-check-bgcolor", i.inputelscolor || "#000"), _ && e.appendChild(t_zeroForms__createNameFieldForCheckbox(a, l, "img-select")), e.appendChild(l), d = _ ? "checkbox" : "radio", c = "t-img-select__indicator_" + (n.li_imgratio ? n.li_imgratio.replace("_", "-") : "1-1"), t.forEach(function(t, e) {
        var r = t_zeroForms__createLabel("img-select", "", !1),
            o = document.createElement("input"),
            e = (o.type = d, o.value = t.alt || t.img, o.classList.add("t-img-select"), _ || (o.name = n.li_nm), _ || o.classList.add("js-tilda-rule"), s && s === e + 1 && (o.checked = !0), a.require && o.setAttribute("data-tilda-req", "1"), r.insertAdjacentElement("beforeend", o), t_zeroForms__createIndicator("img-select", !1, {
                ratio: c,
                img: t.img
            }));
        e.classList.add("t-bgimg"), e.classList.add("t-img-select__indicator"), e.classList.add(c), e.setAttribute("data-original", t.img), e.style.backgroundImage = 'url("' + t.img + '")', r.insertAdjacentElement("beforeend", e), t.alt && ((o = document.createElement("div")).classList.add("t-img-select__text"), o.classList.add("t-text"), o.classList.add("t-text_xs"), o.textContent = t.alt, i.inputtitlecolor && (o.style.color = i.inputtitlecolor), r.insertAdjacentElement("beforeend", o)), l.insertAdjacentElement("beforeend", r)
    }), e
}

function t_zeroForms__createCheckbox(t, e, r, o) {
    var e = t_zeroForms__createLabel("checkbox", e, r),
...
function t_zeroForms__createUploadField(t, e, r) {
    ...
    var o = r ? "t-upwidget" : "t-uploadcare",
        n = t_zeroForms__createWrapper(o),
        i = (n.setAttribute("style", r ? "margin-bottom:5px;min-height:38px;" : "margin-bottom:10px;"), document.createElement("input"));
    return t_zeroForms__appendMainSettingToField(i, e, "hidden", ""), i.setAttribute("role", r ? "upwidget-uploader" : "uploadcare-uploader"), e.require && i.setAttribute("data-tilda-req", "1"), i.style.display = "none", r ? (i.setAttribute("data-tilda-upwidget-key", t.li_uwkey || ""), "y" === t.li_multiupl && i.setAttribute("data-tilda-upwidget-multiple", "1")) : i.setAttribute("data-public-key", t.li_uckey || "demopublickey"), n.insertAdjacentElement("beforeend", i), t_zeroForms__setScriptOrStyle(o + "-zero-form", r ? "tilda-upwidget-1.1.min.js" : "uploadcare-3.x.min.js", "", "script", !1), n
}
...
function t_zeroForms__createQuantityField(t, e, r, o) {
    var n = t_zeroForms__createWrapper("t-inputquantity__wrapper"),
        ...
        r = t_zeroForms__createQuantityBtn("plus", r),
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    var t = t_zeroForms__generateButtonStyles(o, window.getComputedStyle(t).fontFamily),
        o = t_zeroForms__generateButtonHoverStyles(o),
        i = document.getElementById("t-uploadcare-zero-form"),
        a = document.getElementById("t-upwidget-zero-form"),
        s = t_zeroForms__createSelector(e, r, ""),
        l = (s = "published" !== window.tildamode ? '[data-elem-id="' + r + '"] ' : s) + ".t-submit",
        i = (i && (l = l + ", " + s + ".uploadcare--widget__button.uploadcare--widget__button_type_open"), o ? "transition: 0.3s ease all;" : ""),
        a = (l = a ? l + ", " + s + ".t-upwidget-container__button" : l) + "{" + t + i + "}",
        s = "t-zero-form-btn-styles-" + r + "-" + e,
        t = document.getElementById(s);
    t && t.parentElement && t.parentElement.removeChild(t), t_zeroForms__setScriptOrStyle(s, "", a, "style", n), o && (i = l.split(", ").map(function(t) {
        return t + ":hover"
    }).join(", ") + "{" + o + "}", t = "t-zero-form-btn-hover-styles-" + r + "-" + e, (s = document.getElementById(t)) && s.parentElement && s.parentElement.removeChild(s), t_zeroForms__setScriptOrStyle(t, "", i, "style", n))
}
...
function t_zeroForms__generateButtonStyles(t, e) {
    var r, o = {
        ...
        n = "",
        i = ["font-size", "height", "border-radius"];
    for (r in o) o[r] && (i.some(function(t) {
        return t === r.toString()
    }) && (o[r] += "px"), n += r + ":" + o[r] + ";");
    return n += t_zeroForms__processButtonBG(t.buttonbgcolor, !1)
}

function t_zeroForms__processButtonBG(t, e) {
    if (!t) return e ? "" : "background-color: transparent;";
    if (-1 !== t.indexOf("-gradient(")) return "background-image: " + t + ";";
    t = "background-color: " + t + ";";
    return e && (t += "background-image: none;"), t
}
...
function t_zeroForms__generateButtonHoverStyles(t) {
    ...
    return o += t_zeroForms__processButtonBG(t.buttonhoverbgcolor, !0)
}
...
function t_zeroForms__animateInputs(t, o, e, r) {
    ...
    Array.prototype.slice.call(document.querySelectorAll(n + ".t-input:not(.t-inputquantity):not(.t-input-phonemask__wrap):not(.t-input-phonemask)")).forEach(function(t) {
...
function t_zeroForms__createInputPlaceholderStyles(t, r, e, o) {
    var n = ["::-webkit-input-placeholder", "::-moz-placeholder", ":-moz-placeholder", ":-ms-input-placeholder"],
        i = t_zeroForms__createSelector(e, t, ""),
        a = "";
    ["input", "textarea"].forEach(function(e) {
        n.forEach(function(t) {
            a += i + e + t + "{color:" + r.inputcolor + ";opacity:0.5;}"
        })
    }), t_zeroForms__setScriptOrStyle("t-zero-placeholder-" + (e = e || (e = o.closest(".r") ? o.closest(".r").id : "").replace("rec", "")) + "-" + t, "", a, "style", o)
}
...
function t_zeroForms__createLabel(t, e, r) {
    ...
    return o.classList.add("t-" + t + "__control"), e && e.fontSize && (o.style.fontSize = e.fontSize + "px"), e && (o.style.fontWeight = e.fontWeight), r && r.inputtitlecolor && (o.style.color = r.inputtitlecolor), r && r.inputfontfamily && (o.style.fontFamily = r.inputfontfamily), o
}
...
function t_zeroForms__setTitleStyles(t, e, r) {
    ...
    t.style.color = e.color || "", t.style.fontFamily = e.fontFamily || "", t.style.paddingBottom = e.paddingBottom ? e.paddingBottom + "px" : "", o && (t.style.fontSize = e.fontSize ? e.fontSize + "px" : ""), o && r && (t.style.fontWeight = r)
}
...
function t_zeroForms__isFormOutside(t) {
    ...
    var i = (i = e.classList.contains("t396__artboard_scale")) || "window" === t_zeroForms__getFieldValue(e, "data-artboard", "upscale"),
        ...
        e = "scroll" === t.getAttribute("data-animate-prx"),
        t = 0 < r.height && a > r.height && !e;
    return a < 0 && !i && !e || t || n < o
}

function t_zeroForms__getFieldValue(e, r, o) {
    if (e && void 0 !== window.tn) {
        var n = t_zeroForms__getResOpts(e.closest(".t396__artboard")),
            i = "data-field" === r ? "-value" : "",
            t = t_zeroForms__generateAttribute(r, o, i, !1);
        if (n.res === n.resMax) return e.getAttribute(t);
        var a = t_zeroForms__generateAttribute(r, o, i, n.res),
            s = e.getAttribute(a);
...
function t_zeroForms__createSelector(t, e, r) {
    t = "published" === window.tildamode ? "#rec" + t + " " : "";
    return t + ('[data-elem-id="' + e + '"]') + (" " + r)
}
...
function t_zeroForms__updateCheckboxesValues() {
    var t = this.closest("[data-input-lid]"),
        e = Array.prototype.slice.call(t.querySelectorAll(".t-checkbox:checked")),
        r = "",
...
function t_zeroForms__onFuncLoad(r, o) {
    var n;
    "function" == typeof window[r] ? o() : (n = Date.now(), setTimeout(function t() {
        var e = Date.now();
        "function" == typeof window[r] ? o() : ("complete" === document.readyState && 5e3 < e - n && "function" != typeof window[r] && console.warn(r + " is undefined"), setTimeout(t, 100))
    }))
}
